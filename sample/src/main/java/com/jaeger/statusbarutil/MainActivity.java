...
public class MainActivity extends BaseActivity {
    ...
    private int mAlpha = StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChbTranslucent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtils.setTranslucentForDrawerLayout(MainActivity.this, mDrawerLayout, mAlpha);
        ...
        mSbChangeAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtils.setColorForDrawerLayout(MainActivity.this, mDrawerLayout, mStatusBarColor, mAlpha);
                }
        ...
        mSbChangeAlpha.setProgress(StatusBarUtils.DEFAULT_STATUS_BAR_ALPHA);
    }

    @Override
    protected void setStatusBar() {
        mStatusBarColor = getResources().getColor(R.color.colorPrimary);
        StatusBarUtils.setColorForDrawerLayout(this, (DrawerLayout) findViewById(R.id.drawer_layout), mStatusBarColor, mAlpha);
    }
}
